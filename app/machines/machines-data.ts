...
export const MACHINES: Machine[] = [
  ...
  {
    id: "superspray3000",
    tabName: "Superspray 3000L",
    tabSub: "With Mfana boom option",
    tag: "High Volume",
    name: "Superspray 3000L",
    lead: "The heavy-duty workhorse of the range, available with the optional Mfana boom for versatile coverage across a wide range of tree sizes and crop types.",
    specs: [
      { label: "Tank Size", val: "3000L" },
      { label: "Boom Option", val: "Mfana Boom" },
  ...
  {
    id: "superspray2000",
    tabName: "Superspray 2000L",
    tabSub: "Jacto 150 / 300 compatible",
    tag: "Standard Volume",
    name: "Superspray 2000L",
    lead: "The mid-range Superspray offers the same rugged build and Jacto pump compatibility in a 2000L format — ideal for smaller operations or tighter row spacing.",
    specs: [
      { label: "Tank Size", val: "2000L" },
      { label: "Pump Compatibility", val: "Jacto 150 or 300" },
      { label: "Boom Option", val: "Mfana Boom compatible" },
      { label: "Use Case", val: "Citrus & general orchards" },
    ],
    features: [
      "Jacto JP150 or JP300 pump options",
      "Ideal step-up from young tree machines as orchards mature",
      "Full Sprayrite service and parts support",
    ],
  },
  {
    id: "macadamia",
